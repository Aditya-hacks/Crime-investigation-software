...
class Criminal:
    def __init__(self,root):
        ...
        self.root.title('Cyber Investigation Software')
        ...
        self.var_family_name=StringVar()
        self.var_gender=StringVar()
        self.var_wanted=StringVar()


        lbl_title=Label(self.root,text='Cyber Investigation Software',font=('times new roman',40,'bold'),bg='black',fg='gold')
        ...
        self.logo.place(x=365,y=5,width=60,height=60)

        #Img frame
        img_frame=Frame(self.root,bd=2,relief=RIDGE,bg="white")
        img_frame.place(x=0,y=70,width=1530,height=130)

        img_1=Image.open('images/police1.jpg')
        ...
        #2nd
        img_2=Image.open('images/police3.jpg')
        ...
        self.img_3.place(x=1050,y=0,width=540,height=160)
        ...
        #upper frame
        upper_frame=LabelFrame(Main_frame,bd=2,relief=RIDGE,text='Criminal Information',font=('times new roman',11,'bold'),fg='black')
        ...
        #Family Name.
        lbl_familyName=Label(upper_frame,font=("arial",12,"bold"),text="Family Name:",bg="white")
        lbl_familyName.grid(row=1,column=4,sticky=W,padx=2,pady=7)

        txt_familyName=ttk.Entry(upper_frame,textvariable=self.var_family_name,width=22,font=("arial",11,"bold"))
        txt_familyName.grid(row=1,column=5,padx=2,pady=7) 
        ...
        #add button
        btn_add=Button(button_frame,command=self.add_data,text='Save',font=("arial",13,"bold"),width=14,bg='yellow',fg='black')
        btn_add.grid(row=0,column=0,padx=3,pady=5)

        #update button
        btn_update=Button(button_frame,command=self.update_data,text='Update',font=("arial",13,"bold"),width=14,bg='yellow',fg='black')
        btn_update.grid(row=0,column=1,padx=3,pady=5)

        #delete button
        btn_delete=Button(button_frame,command=self.delete_data,text='Delete',font=("arial",13,"bold"),width=14,bg='yellow',fg='black')
        btn_delete.grid(row=0,column=2,padx=3,pady=5)

        #clear button
        btn_clear=Button(button_frame,command=self.clear_data,text='Clear',font=("arial",13,"bold"),width=14,bg='yellow',fg='black')
        btn_clear.grid(row=0,column=3,padx=3,pady=5)

        #background image 
        img_crime=Image.open('images/bg.jpg')
        img_crime=img_crime.resize((540,160),Image.ANTIALIAS)
        self.photocrime=ImageTk.PhotoImage(img_crime)

        self.img_crime=Label(upper_frame,image=self.photocrime)
        self.img_crime.place(x=1000,y=30,width=440,height=160)


        #down Frame
        down_frame=LabelFrame(Main_frame,bd=2,relief=RIDGE,text='Criminal Information Table',font=('times new roman',11,'bold'),fg='black')
        down_frame.place(x=10,y=280,width=1480,height=270)

        #search frame
        search_frame=LabelFrame(down_frame,bd=2,relief=RIDGE,text='Search Criminal Record',font=('times new roman',11,'bold'),fg='black')
        search_frame.place(x=0,y=0,width=1470,height=60)

        
        search_by=Label(search_frame,font=("arial",12,"bold"),text="Search:",bg="yellow",fg='black')
        ...
        #search button
        btn_search=Button(search_frame,command=self.search_data,text='Search',font=("arial",13,"bold"),width=14,bg='yellow',fg='black')
        btn_search.grid(row=0,column=3,padx=3,pady=5)

        #show all button
        btn_all=Button(search_frame,command=self.fetch_data,text='Show All',font=("arial",13,"bold"),width=14,bg='yellow',fg='black')
        btn_all.grid(row=0,column=4,padx=3,pady=5)

        crimeagency=Label(search_frame,font=("arial",30,"bold"),text="CYBER CELL",fg='black')
        crimeagency.grid(row=0,column=5,sticky=W,padx=200)
        ...
        self.criminal_table.heading('12',text='Family Name')
    ...
    def add_data(self):
        if self.var_case_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host='localhost',username='root',password='aditya1234567890',database='criminal1')
                ...
                self.clear_data()
                conn.close()
                messagebox.showerror('Success','Criminal record has been added')
    ...
    def get_cursor(self,event=""):
        ...
        self.var_family_name.set(data[11])
        ...
        if self.var_case_id.get()=="":
            ...
            try:
                ...
                if update>0:
                    conn=mysql.connector.connect(host='localhost',username='root',password='aditya1234567890',database='criminal1')
                    my_cursor=conn.cursor()
                    my_cursor.execute('update criminal1 set Criminal_no=%s,Criminal_name=%s,Nick_name=%s,arrest_date=%s,dateOfcrime=%s,address=%s,age=%s,occupation=%s,BirthMark=%s,crimeType=%s,familyName=%s,gender=%s,wanted=%s where Case_id=%s',(
