...
--
-- Host: localhost    Database: criminal1
-- ------------------------------------------------------
...
DROP TABLE IF EXISTS `criminal1`;
...
LOCK TABLES `criminal1` WRITE;
/*!40000 ALTER TABLE `criminal1` DISABLE KEYS */;
INSERT INTO `criminal1` VALUES ('14','231','fw','few','09/08/2016','09/09/2009','tyu','37','ffe','till','nff','fwqi','male','yes');
/*!40000 ALTER TABLE `criminal1` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-09-19 15:19:31
